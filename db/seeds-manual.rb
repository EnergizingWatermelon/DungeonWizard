...
monsters = [{:name => 'Rattata', :xp => '20', :cr => '0.05', :initiative => '0', :hp => '1', :ac => '12', :ac_touch => '12', :ac_flat => '10', :fort_save => '-1', :ref_save => '2', :will_save => '-1', :str => '6', :dex => '14', :con => '10', :int => '10', :wis => '8', :cha => '8', :monster_type => 'pocket', :alignment => 'CE', :organization => 'solitary, gang, nest', :climate => 'Any', :terrain => 'Forest'},
            ...
            {:name => 'Giant Scorpion', :xp => '800', :cr => '3', :climate => 'Warm', :terrain => 'Desert', :initiative => 0, :hp => '37', :ac => '16', :ac_touch => '9', :ac_flat => '16', :fort_save => '7', :ref_save => '1', :will_save => '1', :str => '19', :dex => '10', :con => '16', :int => '0', :wis => '10', :cha => '2', :monster_type => 'vermin', :alignment => 'N', :organization => 'solitary'},
            {:name => 'Yeti', :xp => '1200', :cr => '4', :climate => 'Cold', :terrain => 'Mountains', :organization => 'solitary'},
            {:name => 'Dire Shark', :xp => '600', :cr => '2', :climate => 'Any', :terrain => 'Ocean', :organization => 'solitary, pair'},
            {:name => 'Killer Whale', :xp => '100', :cr => '0.25', :climate => 'Cold', :terrain => 'Ocean', :organization => 'solitary, pair, gang'},
            {:name => 'Gorgon', :xp => '4800', :cr => '8', :climate => 'Temperate', :terrain => 'Plains', :organization => 'solitary'},
            {:name => 'Dracolisk', :xp => '3200', :cr => '7', :climate => 'Temperate', :terrain => 'Swamp', :organization => 'solitary, colony'},
            {:name => 'Dark Stalker', :xp => '1200', :cr => '4', :climate => 'Cold', :terrain => 'Underground', :organization => 'solitary, gang, clan'},
            {:name => 'Dark Stalker', :xp => '1200', :cr => '4', :climate => 'Temperate', :terrain => 'Underground', :organization => 'solitary, gang, clan'},
            {:name => 'Dark Stalker', :xp => '1200', :cr => '4', :climate => 'Warm', :terrain => 'Underground', :organization => 'solitary, gang, clan'},
            {:name => 'Giant Frilled Lizard', :xp => '1600', :cr => '5', :climate => 'Warm', :terrain => 'Forest', :organization => 'solitary, pair, gang'},
            ...
            #http://www.d20pfsrd.com/bestiary/monster-listings/outsiders/blood-queen
            {:name => 'Blood Queen', :xp => '819200', :cr => '23', :initiative => '4', :hp => '471', :ac => '38', :ac_touch => '6', :ac_flat => '38', :fort_save => '28', :ref_save => '9', :will_save => '24', :str => '30', :dex => '11', :con => '40', :int => '20', :wis => '29', :cha => '37', :monster_type => 'Outsider', :alignment => 'CE', :organization => 'solitary', :climate => 'Any', :terrain => 'Forest'},
            {:name => 'Blood Queen', :xp => '819200', :cr => '23', :initiative => '4', :hp => '471', :ac => '38', :ac_touch => '6', :ac_flat => '38', :fort_save => '28', :ref_save => '9', :will_save => '24', :str => '30', :dex => '11', :con => '40', :int => '20', :wis => '29', :cha => '37', :monster_type => 'Outsider', :alignment => 'CE', :organization => 'solitary', :climate => 'Any', :terrain => 'Underground'},
            {:name => 'Blood Queen', :xp => '819200', :cr => '23', :initiative => '4', :hp => '471', :ac => '38', :ac_touch => '6', :ac_flat => '38', :fort_save => '28', :ref_save => '9', :will_save => '24', :str => '30', :dex => '11', :con => '40', :int => '20', :wis => '29', :cha => '37', :monster_type => 'Outsider', :alignment => 'CE', :organization => 'solitary', :climate => 'Any', :terrain => 'Ocean'},
            {:name => 'Blood Queen', :xp => '819200', :cr => '23', :initiative => '4', :hp => '471', :ac => '38', :ac_touch => '6', :ac_flat => '38', :fort_save => '28', :ref_save => '9', :will_save => '24', :str => '30', :dex => '11', :con => '40', :int => '20', :wis => '29', :cha => '37', :monster_type => 'Outsider', :alignment => 'CE', :organization => 'solitary', :climate => 'Any', :terrain => 'Mountains'},
            {:name => 'Blood Queen', :xp => '819200', :cr => '23', :initiative => '4', :hp => '471', :ac => '38', :ac_touch => '6', :ac_flat => '38', :fort_save => '28', :ref_save => '9', :will_save => '24', :str => '30', :dex => '11', :con => '40', :int => '20', :wis => '29', :cha => '37', :monster_type => 'Outsider', :alignment => 'CE', :organization => 'solitary', :climate => 'Any', :terrain => 'Plains'},
            {:name => 'Blood Queen', :xp => '819200', :cr => '23', :initiative => '4', :hp => '471', :ac => '38', :ac_touch => '6', :ac_flat => '38', :fort_save => '28', :ref_save => '9', :will_save => '24', :str => '30', :dex => '11', :con => '40', :int => '20', :wis => '29', :cha => '37', :monster_type => 'Outsider', :alignment => 'CE', :organization => 'solitary', :climate => 'Any', :terrain => 'Swamp'},
            #http://www.d20pfsrd.com/bestiary/monster-listings/magical-beasts/spawn-of-destruction/the-monarch-worm
            {:name => 'The Monarch Worm", :xp => 819200', :cr => '23', :initiative => '5', :hp => ''}
  	 ]
